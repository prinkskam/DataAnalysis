...
MONGO_HOST= 'mongodb://localhost/db_twitter1'  # assuming you have mongoDB installed locally
                                             # and a database called 'company'
 
WORDS = ['#Fear', '#Anger', '#Shame', '#Faith', '#Victim', '#Punish', '#Justice']
